...
function changeBackground(condition) {
  ...
  switch (condition) {
    case 'Clear':
      url = 'https://images.unsplash.com/photo-1506744038136-46273834b3fb?fit=crop&w=1920&q=80';
      break;
    case 'Clouds':
      url = 'https://images.unsplash.com/photo-1610878180933-67f891b5d10d?fit=crop&w=1920&q=80';
      break;
    case 'Rain':
      url = 'https://images.unsplash.com/photo-1501594907352-04cda38ebc29?fit=crop&w=1920&q=80';
      break;
    case 'Snow':
      url = 'https://images.unsplash.com/photo-1608889175657-294b69ecf3a5?fit=crop&w=1920&q=80';
      break;
    case 'Thunderstorm':
      url = 'https://images.unsplash.com/photo-1600267452157-4cba2c17c9aa?fit=crop&w=1920&q=80';
      break;
    default:
      url = 'https://images.unsplash.com/photo-1561484930-e38d0fbfbb55?fit=crop&w=1920&q=80';
  }
